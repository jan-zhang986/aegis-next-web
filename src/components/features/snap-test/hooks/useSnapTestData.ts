...
export function useSnapTestData(
  ...
  const [dataFactoryStats, setDataFactoryStats] = useState<OverviewData['dataFactoryStats']>(null);
  const [mqStats, setMqStats] = useState<OverviewData['mqStats']>(null);
  const [mockFactoryStats, setMockFactoryStats] = useState<OverviewData['mockFactoryStats']>(null);
  const [testPlanStats, setTestPlanStats] = useState<OverviewData['testPlanStats']>(null);
  const [automationStats, setAutomationStats] = useState<OverviewData['automationStats']>(null);
  const [automationRunStats, setAutomationRunStats] = useState<OverviewData['automationRunStats']>(null);
  const [functionalCaseExecutionStats, setFunctionalCaseExecutionStats] = useState<OverviewData['functionalCaseExecutionStats']>(null);
  const [aiCaseStats, setAiCaseStats] = useState<OverviewData['aiCaseStats']>(null);
